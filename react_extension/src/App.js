                    ...
                    {item.youtubeVideo ? (
                      <div>
                        <iframe
                          ...
                          height="315"
                        />
                        <p className="video-title">{item.draft.title}</p>
                        <div className="video-stats">
                          <div>
          ...
          return (
            <div>
              <div className="container">
                ...
                <div className="row">
                  {idx(data, _ => _.gitHub.user.repositories.nodes).map(
                    (item, index) => {
                      return (
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-md-8">
                    ...
                    <p>{idx(data, _ => _.gitHub.user.location)}</p>
                    <p className="info-list">
              ...
              <div className="container">
                <div className="row">
                  ...
                  <div className="col-md-8">
                    ...
                    <p>{idx(data, _ => _.eventil.user.profile.description)}</p>
                    <p className="info-list">
                      <i className="fas fa-envelope" />{' '}
